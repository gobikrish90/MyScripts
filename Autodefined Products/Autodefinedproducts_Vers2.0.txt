<#
.SYNOPSIS
    ProPhoenix Full Maintenance Generator (COMPLETE ANALYSIS VERSION).
    1. Uses your UPDATED Service List & Mapping Data.
    2. AUTOMATICALLY ADDS missing products found in your AppReg_Main.xml (PhoenixHub, PaymentGateway, etc.).
    3. Generates "Hotfix_Automation.bat" with Full Logging, Verification, and Stability fixes.
#>
...
# UPDATED SERVICE LIST (FROM USER)
$ServiceProductList = @(
...
foreach ($FoundPath in $FoundFiles) {
    ...
    # --- BATCH FILE CONTENT ---
    # Includes all stability fixes + Updated Configuration + Missing Mappings
    $BatchContent = @"
$CdBlock
@echo off
