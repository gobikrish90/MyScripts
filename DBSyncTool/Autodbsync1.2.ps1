# ======================================================================
#  ProPhoenix Auto Database Sync Utility - v4.1 (Exclude System Master)
# ======================================================================

Clear-Host
Write-Host "===== ProPhoenix Auto Database Sync Utility (v4.1) =====" -ForegroundColor Cyan
...
# ----------------------------------------------------------------------
# HELPER: FETCH DATABASES FROM SQL (UPDATED TO EXCLUDE MASTER)
# ----------------------------------------------------------------------
function Get-PhoenixDBs {
    ...
    try {
        ...
        # UPDATED QUERY: Exclude 'master', 'model', 'msdb', 'tempdb'
...
if ($runSetup) {
    ...
    # Extra safety filter in PowerShell to remove 'master' if SQL query missed it
...
foreach ($db in $DBNames) {
    ...
    # SAFETY CHECK: Skip system master if it slipped through
