...
# ======================================================================
#  ProPhoenix DB Utility Dashboard - v6.9 
# ======================================================================
...
$form.Text = "ProPhoenix DB Utility Dashboard - v6.9"
...
$txtPath = New-Object System.Windows.Forms.TextBox; $txtPath.Location="820,12"; $txtPath.Size="350,25"; $txtPath.BackColor=$colInputBg; $txtPath.ForeColor="White"; $txtPath.BorderStyle="FixedSingle"; $pnlHead.Controls.Add($txtPath)
...
$cmbEnv = New-Object System.Windows.Forms.ComboBox; $cmbEnv.Items.AddRange(@("LIVE", "TEST", "ALL")); $cmbEnv.SelectedIndex=0; $cmbEnv.Location="0,20"; $cmbEnv.Width=90; $cmbEnv.BackColor=$colInputBg; $cmbEnv.ForeColor="White"; $cmbEnv.DropDownStyle="DropDownList"; $pnEnv.Controls.Add($cmbEnv)
$flowCon.Controls.Add($pnEnv)

# SYNC TYPE SELECTOR
$pnSyncType = New-Object System.Windows.Forms.Panel; $pnSyncType.Size=New-Object System.Drawing.Size(160,50)
$lbSyncType = New-Object System.Windows.Forms.Label; $lbSyncType.Text="Sync Type"; $lbSyncType.AutoSize=$true; $lbSyncType.ForeColor="Cyan"; $lbSyncType.Font=$fontNorm; $pnSyncType.Controls.Add($lbSyncType)
$cmbSyncType = New-Object System.Windows.Forms.ComboBox; $cmbSyncType.Items.AddRange(@("1 - Update DB", "2 - Upgrade DB", "3 - Multiple DB")); $cmbSyncType.SelectedIndex=2; $cmbSyncType.Location="0,20"; $cmbSyncType.Width=150; $cmbSyncType.BackColor=$colInputBg; $cmbSyncType.ForeColor="White"; $cmbSyncType.DropDownStyle="DropDownList"; $pnSyncType.Controls.Add($cmbSyncType)
...
$chkAutoSync = New-Object System.Windows.Forms.CheckBox; $chkAutoSync.Text="Auto DB Sync"; $chkAutoSync.ForeColor="Yellow"; $chkAutoSync.AutoSize=$true; $chkAutoSync.Checked=$true; $chkAutoSync.Margin=New-Object System.Windows.Forms.Padding(10,25,0,0); $flowCon.Controls.Add($chkAutoSync)
...
$btnVer = New-Object System.Windows.Forms.Button; $btnVer.Text="CHECK DB VERSION"; $btnVer.Dock="Fill"; $btnVer.BackColor=[System.Drawing.Color]::DarkOrange; $btnVer.ForeColor="White"; $btnVer.FlatStyle="Flat"; $btnVer.Font=$fontHeader; $pnlAct.Controls.Add($btnVer, 2, 0)
...
$CleanAndKill = {
    ...
    try {
        ...
        $killCmd.CommandText = "DECLARE @k1 varchar(8000) = ''; SELECT @k1 = @k1 + 'kill ' + CONVERT(varchar(5), session_id) + ';' FROM sys.dm_exec_sessions WHERE database_id = db_id('$dbTarget'); EXEC(@k1);"
...
# --- REUSABLE SYNC FUNCTION (GROUPED BATCH + LOG EXTRACTION) ---
function Execute-DBSync {
    ...
    $syncMode = $cmbSyncType.SelectedItem.Substring(0,1)
    ...
    if ($syncMode -eq "3") {
        ...
        foreach ($F in $groupedDBs.Keys) {
            ...
            # 1. Pre-cleanup ALL databases in the group
            foreach ($D in $groupedDBs[$F]) { & $CleanAndKill $D }
            Start-Sleep -Seconds 2

            # 2. EXACT XML GENERATION (SEMICOLON SEPARATED)
...
<PnxPakager>
	<SourceServer>
		...
		<DBName>$dbList</DBName> <UserName>$($txtU.Text)</UserName> 
...
"@
            ...
            if ($SyncProc.ExitCode -eq 0) {
                ...
                Extract-SyncLog $WD  # Inject Log Catcher Here
            }
    ...
    # -------------------------------------------------------------
        ...
        foreach ($i in $Items) {
            ...
            Log "Updating $($D) (SyncType $syncMode)..." "Cyan"; [System.Windows.Forms.Application]::DoEvents()
...
$btnCon.Add_Click({
    ...
    try {
        ...
        foreach ($row in $ds.Tables[0].Rows) {
            ...
            # If $EnvMode -eq "ALL", we do not skip anything.
