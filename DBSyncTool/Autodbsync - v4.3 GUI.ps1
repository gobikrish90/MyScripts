# ======================================================================
#  ProPhoenix DB Utility Dashboard - v60.0 (Layout & Visibility Fix)
# ======================================================================
...
$fontLog    = New-Object System.Drawing.Font("Consolas", 9) # Fixed Width Font for Logs
$fontArrow  = New-Object System.Drawing.Font("Segoe UI", 24, [System.Drawing.FontStyle]::Bold)
...
$lblVerDisplay = New-Object System.Windows.Forms.Label; $lblVerDisplay.Text = "Utility Ver: --"; $lblVerDisplay.AutoSize=$false; $lblVerDisplay.TextAlign="MiddleRight"; $lblVerDisplay.Size="300,30"; $lblVerDisplay.Location="850,20"; $lblVerDisplay.Font=$fontHeader; $lblVerDisplay.ForeColor=$colProc; $pnlHead.Controls.Add($lblVerDisplay)

# --- MAIN FLOW PANEL ---
$pnlBody = New-Object System.Windows.Forms.Panel; $pnlBody.Dock="Fill"; $pnlBody.Padding=15; $form.Controls.Add($pnlBody)

# === COLUMN 1: SOURCE (RED) ===
$grpSrc = New-Object System.Windows.Forms.GroupBox; $grpSrc.Text=" 1. Connect "; $grpSrc.Location="20,10"; $grpSrc.Size="320,480"; $grpSrc.ForeColor=$colSrc; $grpSrc.Font=$fontHeader; $pnlBody.Controls.Add($grpSrc)
...
# Arrow 1
$lblArrow1 = New-Object System.Windows.Forms.Label; $lblArrow1.Text="➜"; $lblArrow1.Location="355,220"; $lblArrow1.AutoSize=$true; $lblArrow1.Font=$fontArrow; $lblArrow1.ForeColor="LightGray"; $pnlBody.Controls.Add($lblArrow1)

# === COLUMN 2: PROCESS (TEAL) ===
$grpProc = New-Object System.Windows.Forms.GroupBox; $grpProc.Text=" 2. Select Targets "; $grpProc.Location="410,10"; $grpProc.Size="320,480"; $grpProc.ForeColor=$colProc; $grpProc.Font=$fontHeader; $pnlBody.Controls.Add($grpProc)

# FIX: Moved Checkbox Up to avoid overlap
$chkAll = New-Object System.Windows.Forms.CheckBox
$chkAll.Text="Select All Databases"
$chkAll.Location="20,25"  
$chkAll.Size="280,30"
$chkAll.Font=$fontNorm
$chkAll.ForeColor="Black"
$grpProc.Controls.Add($chkAll)

# FIX: Moved List Down to avoid overlap
$listDBs = New-Object System.Windows.Forms.CheckedListBox
$listDBs.Location="20,60" 
$listDBs.Size="280,400"
$listDBs.BorderStyle="None"
$listDBs.BackColor=$colInputBg
$listDBs.Font=$fontNorm
$listDBs.CheckOnClick=$true
$grpProc.Controls.Add($listDBs)

# Arrow 2
$lblArrow2 = New-Object System.Windows.Forms.Label; $lblArrow2.Text="➜"; $lblArrow2.Location="745,220"; $lblArrow2.AutoSize=$true; $lblArrow2.Font=$fontArrow; $lblArrow2.ForeColor="LightGray"; $pnlBody.Controls.Add($lblArrow2)

# === COLUMN 3: OUTPUT (BLUE) ===
$grpOut = New-Object System.Windows.Forms.GroupBox; $grpOut.Text=" 3. Live Logs "; $grpOut.Location="800,10"; $grpOut.Size="350,480"; $grpOut.ForeColor=$colOut; $grpOut.Font=$fontHeader; $pnlBody.Controls.Add($grpOut)

# FIX: Added Scrollbars and better font
$txtLog = New-Object System.Windows.Forms.RichTextBox
$txtLog.Location="15,35"
$txtLog.Size="320,430"
$txtLog.BorderStyle="None"
$txtLog.BackColor="White"
$txtLog.ForeColor="Black"
$txtLog.Font=$fontLog
$txtLog.ReadOnly=$true
$txtLog.ScrollBars="ForcedVertical" # Force Scrollbar Visibility
$grpOut.Controls.Add($txtLog)

# --- ACTION PANEL (MIDDLE STRIP) ---
$pnlAction = New-Object System.Windows.Forms.Panel; $pnlAction.Dock="Bottom"; $pnlAction.Height=80; $pnlAction.BackColor="White"; $form.Controls.Add($pnlAction)

# Start Sync (Centered Left)
$btnSync = New-Object System.Windows.Forms.Button; $btnSync.Text="START SYNC ➜"; $btnSync.Location="250,15"; $btnSync.Size="300,50"; $btnSync.BackColor=$colProc; $btnSync.ForeColor="White"; $btnSync.Font=$fontHeader; $btnSync.FlatStyle="Flat"; $pnlAction.Controls.Add($btnSync)

# Check Versions (Centered Right)
$btnVer = New-Object System.Windows.Forms.Button; $btnVer.Text="CHECK DB VERSIONS"; $btnVer.Location="600,15"; $btnVer.Size="300,50"; $btnVer.BackColor=$btnOrange; $btnVer.ForeColor="White"; $btnVer.Font=$fontHeader; $btnVer.FlatStyle="Flat"; $pnlAction.Controls.Add($btnVer)
