...
# ======================================================================
#  ProPhoenix DB Utility Dashboard - v7.2
# ======================================================================
...
$form.Text = "ProPhoenix DB Utility Dashboard v7.2"
...
$btnBrowse = New-Object System.Windows.Forms.Button; $btnBrowse.Text="Browse"; $btnBrowse.Location="1180,12"; $btnBrowse.Size="80,25"; $btnBrowse.BackColor=$colBtn; $btnBrowse.ForeColor="White"; $btnBrowse.FlatStyle="Flat"; $pnlHead.Controls.Add($btnBrowse)
...
$Script:cmbSyncType.Items.AddRange(@("2 - Upgrade an existing database", "3 - Upgrade multiple databases"))
...
$btnCon = New-Object System.Windows.Forms.Button; $btnCon.Text="CONNECT"; $btnCon.Size="110,35"; $btnCon.BackColor=[System.Drawing.Color]::Crimson; $btnCon.ForeColor="White"; $btnCon.FlatStyle="Flat"; $btnCon.Margin=New-Object System.Windows.Forms.Padding(15,15,0,0); $flowCon.Controls.Add($btnCon)
...
$btnSync = New-Object System.Windows.Forms.Button; $btnSync.Text="START SYNC PACKAGE"; $btnSync.Dock="Fill"; $btnSync.BackColor=[System.Drawing.Color]::DeepSkyBlue; $btnSync.ForeColor="White"; $btnSync.FlatStyle="Flat"; $btnSync.Font=$fontHeader; $btnSync.Margin=$btnMargin; $pnlAct.Controls.Add($btnSync, 0, 0)
$btnCopyDB = New-Object System.Windows.Forms.Button; $btnCopyDB.Text="COPY TO TRAIN/TEST"; $btnCopyDB.Dock="Fill"; $btnCopyDB.BackColor=[System.Drawing.Color]::Teal; $btnCopyDB.ForeColor="White"; $btnCopyDB.FlatStyle="Flat"; $btnCopyDB.Font=$fontHeader; $btnCopyDB.Margin=$btnMargin; $pnlAct.Controls.Add($btnCopyDB, 1, 0)
$btnVer = New-Object System.Windows.Forms.Button; $btnVer.Text="CHECK VERSION"; $btnVer.Dock="Fill"; $btnVer.BackColor=[System.Drawing.Color]::DarkOrange; $btnVer.ForeColor="White"; $btnVer.FlatStyle="Flat"; $btnVer.Font=$fontHeader; $btnVer.Margin=$btnMargin; $pnlAct.Controls.Add($btnVer, 2, 0)
$btnBackup = New-Object System.Windows.Forms.Button; $btnBackup.Text="BACKUP JOBS & PARAMS"; $btnBackup.Dock="Fill"; $btnBackup.BackColor=[System.Drawing.Color]::MediumPurple; $btnBackup.ForeColor="White"; $btnBackup.FlatStyle="Flat"; $btnBackup.Font=$fontHeader; $btnBackup.Margin=$btnMargin; $pnlAct.Controls.Add($btnBackup, 0, 1)
$btnRestore = New-Object System.Windows.Forms.Button; $btnRestore.Text="RESTORE JOBS & PARAMS"; $btnRestore.Dock="Fill"; $btnRestore.BackColor=[System.Drawing.Color]::DarkSlateBlue; $btnRestore.ForeColor="White"; $btnRestore.FlatStyle="Flat"; $btnRestore.Font=$fontHeader; $btnRestore.Margin=$btnMargin; $pnlAct.Controls.Add($btnRestore, 1, 1)
$btnDeleteDB = New-Object System.Windows.Forms.Button; $btnDeleteDB.Text="DELETE DATABASE"; $btnDeleteDB.Dock="Fill"; $btnDeleteDB.BackColor=[System.Drawing.Color]::Crimson; $btnDeleteDB.ForeColor="White"; $btnDeleteDB.FlatStyle="Flat"; $btnDeleteDB.Font=$fontHeader; $btnDeleteDB.Margin=$btnMargin; $pnlAct.Controls.Add($btnDeleteDB, 2, 1)
...
function Toggle($s) { 
    $btnCon.Enabled=$s; $btnSync.Enabled=$s; $btnBackup.Enabled=$s; 
    $btnRestore.Enabled=$s; $btnVer.Enabled=$s; $btnCreateDB.Enabled=$s; 
    $btnCopyDB.Enabled=$s; $btnDeleteDB.Enabled=$s; $Script:btnSqlMem.Enabled=$s
}
...
$CleanAndKill = {
    ...
    try {
        ...
        $killCN.Close()
        Log "   > Cleared locks & dropped orphaned Temp databases (Exclusive Access Granted)" "DarkGray"
    } catch {}
}
...
function Extract-SyncLog {
    ...
    try {
        ...
        $latestLog = Get-ChildItem -Path $logDirs -File -Include *.log, *.txt -Exclude "PnxAutoNewDBSyn.xml", "sync_*.txt" -ErrorAction SilentlyContinue | Sort-Object LastWriteTime -Descending | Select-Object -First 1
...
function Execute-DBSync {
    ...
    try {
        ...
        # -------------------------------------------------------------
        if ($isMulti) {
            Log "   > Mode: MULTIPLE DB (SyncType 3). Grouping databases by utility folder." "Cyan"
            ...
            # INTELLIGENT SORTING: Phoenix Master runs FIRST
            $safeKeys = @()
            ...
            foreach ($F in $sortedFolders) {
                ...
                Log "Updating Multiple DBs in [$F]: $dbList" "Yellow"; [System.Windows.Forms.Application]::DoEvents()

                if (!(Test-Path "$WD\PnxDBSync.exe")) { Log "   ! Skipped: Missing EXE in $WD" "Orange"; continue }

                # Pre-cleanup ALL databases in the group
                foreach ($D in $groupedDBs[$F]) { & $CleanAndKill $D }
                Start-Sleep -Seconds 2

                # XML GENERATION (EXACT RAW TEXT, NO BOM)
...
"@
                ...
                # VISIBLE EXECUTION + POPUP AUTO-CLICKER
        ...
        # -------------------------------------------------------------
        # SYNCTYPE 2: INDIVIDUAL UPDATE / UPGRADE EXECUTION
        # -------------------------------------------------------------
        else {
            ...
            foreach ($i in $sortedItems) {
                ...
                Log "Executing $($D) (SyncType 2)..." "Cyan"; [System.Windows.Forms.Application]::DoEvents()
...
$btnCreateDB.Add_Click({ 
    try {
        ...
        Log "  ✔ Created" "Lime"; $btnCon.PerformClick() 
