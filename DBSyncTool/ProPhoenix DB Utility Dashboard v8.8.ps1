...
# ======================================================================
# --- COPY DB (LIVE TO TRAIN/TEST) - SQL-SIDE ICOMPARABLE FIX ---
# ======================================================================
...
$Script:btnCopyDB.Add_Click({
    try {
        ...
        # PRO-MODE FIX: Let SQL handle the NULL. It will always return 0 if the DB doesn't exist.
        ...
        # PRO-MODE FIX: Let SQL handle the NULL. Returns 'Unknown' explicitly if sum fails.
