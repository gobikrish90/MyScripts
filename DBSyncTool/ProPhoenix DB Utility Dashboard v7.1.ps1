...
# ======================================================================
#  ProPhoenix DB Utility Dashboard - v7.0
# ======================================================================

# --- AUTO-ELEVATE TO ADMINISTRATOR ---
$principal = [Security.Principal.WindowsPrincipal][Security.Principal.WindowsIdentity]::GetCurrent()
if (-not $principal.IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
    # Explicitly use standard powershell.exe as ISE does not support the ExecutionPolicy flag
...
$form.Text = "ProPhoenix DB Utility Dashboard - v7.0"
...
$lblTitle = New-Object System.Windows.Forms.Label; $lblTitle.Text="ProPhoenix DB Utility Dashboard"; $lblTitle.AutoSize=$true; $lblTitle.Location="100,15"; $lblTitle.Font=$fontTitle; $lblTitle.ForeColor=[System.Drawing.Color]::DodgerBlue; $pnlHead.Controls.Add($lblTitle)
...
$Script:cmbSyncType.Items.AddRange(@("Update / Upgrade DB", "Multiple DB Sync"))
$Script:cmbSyncType.SelectedIndex=0
...
$Script:txtLog = New-Object System.Windows.Forms.RichTextBox; $Script:txtLog.Dock="Fill"; $Script:txtLog.BackColor=$colList; $Script:txtLog.ForeColor="LightGray"; $Script:txtLog.BorderStyle="None"; $Script:txtLog.Font=$fontLog; $grpLog.Controls.Add($Script:txtLog); $btnClear.Add_Click({ $Script:txtLog.Clear() })
...
$btnSync = New-Object System.Windows.Forms.Button; $btnSync.Text="START DB SYNC"; $btnSync.Dock="Fill"; $btnSync.BackColor=[System.Drawing.Color]::DeepSkyBlue; $btnSync.ForeColor="White"; $btnSync.FlatStyle="Flat"; $btnSync.Font=$fontHeader; $pnlAct.Controls.Add($btnSync, 0, 0)
$btnCopyDB = New-Object System.Windows.Forms.Button; $btnCopyDB.Text="LIVE TO TRAIN/TEST"; $btnCopyDB.Dock="Fill"; $btnCopyDB.BackColor=[System.Drawing.Color]::Teal; $btnCopyDB.ForeColor="White"; $btnCopyDB.FlatStyle="Flat"; $btnCopyDB.Font=$fontHeader; $btnCopyDB.Margin=New-Object System.Windows.Forms.Padding(10,0,10,0); $pnlAct.Controls.Add($btnCopyDB, 1, 0)
...
function Toggle($s) { 
    ...
    $btnCopyDB.Enabled=$s; $btnDeleteDB.Enabled=$s; 
}
...
$CleanAndKill = {
    ...
    try {
        ...
        $killCN.Close()
        Log "   > Cleared locks and dropped old Temp databases (Exclusive Access Granted)" "DarkGray"
    } catch {}
}
...
$btnCon.Add_Click({
    try {
        ...
        Log "Connecting in [$($Script:cmbEnv.SelectedItem)] Mode..." "White"
        ...
        Log "✔ Connected." "Lime"; $lblStat.Text = "Connected."; Save-Creds; Scan-Server $Script:txtS.Text 
        ...
        if($Script:listDBs.Items.Count -gt 0){ Log "   + Listed & Grouped Databases" "Cyan" }
...
$btnCreateDB.Add_Click({ 
    try {
        ...
        Toggle $false; Log "Creating..." "Cyan"; 
    ...
    } catch {Log "Err" "Red"} finally { Toggle $true } 
})
