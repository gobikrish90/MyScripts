...
# --- THEME (OBSIDIAN FORGE / GOLD) ---
$hexBg = "#111111"        # Pure Matte Black
$hexInputBg = "#1A1A1A"   # Subtle Charcoal
$hexText = "#F4F4F5"      # Zinc White
$hexAccent = "#FACC15"    # Premium Gold/Amber
$hexDanger = "#DC2626"    # Standard Crimson

$colBg = [System.Drawing.ColorTranslator]::FromHtml($hexBg)
$colText = [System.Drawing.ColorTranslator]::FromHtml($hexText)
$colInputBg = [System.Drawing.ColorTranslator]::FromHtml($hexInputBg)
$fontTitle = New-Object System.Drawing.Font("Consolas", 22, [System.Drawing.FontStyle]::Bold)
$fontHeader = New-Object System.Drawing.Font("Consolas", 11, [System.Drawing.FontStyle]::Bold)
$fontNorm = New-Object System.Drawing.Font("Segoe UI", 9)
$fontLog = New-Object System.Drawing.Font("Consolas", 10) 

# --- ENTERPRISE GHOST BUTTON GENERATOR ---
function Set-ProButton($btn, $accentHex) {
    $c = [System.Drawing.ColorTranslator]::FromHtml($accentHex)
    $btn.FlatStyle = "Flat"
    ...
    # Hover effect to flip text color
    $btn.Add_MouseEnter({ $btn.ForeColor = [System.Drawing.Color]::Black })
    $btn.Add_MouseLeave({ $btn.ForeColor = $c })
}

# --- FORM SETUP ---
$form = New-Object System.Windows.Forms.Form
$form.Text = "ProPhoenix DB Utility - Enterprise Ops"
...
$lblTitle = New-Object System.Windows.Forms.Label; $lblTitle.Text="DB SYNC DASHBOARD"; $lblTitle.AutoSize=$true; $lblTitle.Location="100,15"; $lblTitle.Font=$fontTitle; $lblTitle.ForeColor=[System.Drawing.ColorTranslator]::FromHtml($hexAccent); $pnlHead.Controls.Add($lblTitle)
$lblPath = New-Object System.Windows.Forms.Label; $lblPath.Text="Utility Path:"; $lblPath.Location="750,15"; $lblPath.AutoSize=$true; $lblPath.ForeColor=$colText; $pnlHead.Controls.Add($lblPath)
$Script:txtPath = New-Object System.Windows.Forms.TextBox; $Script:txtPath.Location="820,12"; $Script:txtPath.Size="350,25"; $Script:txtPath.BackColor=$colInputBg; $Script:txtPath.ForeColor=[System.Drawing.ColorTranslator]::FromHtml($hexAccent); $Script:txtPath.BorderStyle="FixedSingle"; $Script:txtPath.Font=$fontNorm; $pnlHead.Controls.Add($Script:txtPath)
$Script:btnBrowse = New-Object System.Windows.Forms.Button; $Script:btnBrowse.Text="BROWSE"; $Script:btnBrowse.Location="1180,12"; $Script:btnBrowse.Size="80,25"; Set-ProButton $Script:btnBrowse $hexAccent; $pnlHead.Controls.Add($Script:btnBrowse)

$lblVerDisplay = New-Object System.Windows.Forms.Label; $lblVerDisplay.Text="Ver: --"; $lblVerDisplay.AutoSize=$false; $lblVerDisplay.TextAlign="MiddleRight"; $lblVerDisplay.Size="300,20"; $lblVerDisplay.Location="960,40"; $lblVerDisplay.ForeColor=[System.Drawing.Color]::Gray; $pnlHead.Controls.Add($lblVerDisplay)
...
$Script:btnCreateDB = New-Object System.Windows.Forms.Button; $Script:btnCreateDB.Text="CREATE NEW DB"; $Script:btnCreateDB.Location="200,15"; $Script:btnCreateDB.Size="160,40"; Set-ProButton $Script:btnCreateDB "#00D2FF"; $pnlAdmin.Controls.Add($Script:btnCreateDB)
$Script:btnInstall = New-Object System.Windows.Forms.Button; $Script:btnInstall.Text="INSTALL UTILITY"; $Script:btnInstall.Location="380,15"; $Script:btnInstall.Size="160,40"; Set-ProButton $Script:btnInstall $hexAccent; $pnlAdmin.Controls.Add($Script:btnInstall)
$Script:btnUninstall = New-Object System.Windows.Forms.Button; $Script:btnUninstall.Text="UNINSTALL UTILITY"; $Script:btnUninstall.Location="560,15"; $Script:btnUninstall.Size="160,40"; Set-ProButton $Script:btnUninstall $hexDanger; $pnlAdmin.Controls.Add($Script:btnUninstall)
$Script:btnSqlMem = New-Object System.Windows.Forms.Button; $Script:btnSqlMem.Text="CONFIG SQL RAM"; $Script:btnSqlMem.Location="740,15"; $Script:btnSqlMem.Size="180,40"; Set-ProButton $Script:btnSqlMem "#B026FF"; $pnlAdmin.Controls.Add($Script:btnSqlMem)

# --- CONNECTION ---
$grpCon = New-Object System.Windows.Forms.GroupBox; $grpCon.Text=" SERVER CONNECTION "; $grpCon.Dock="Fill"; $grpCon.ForeColor=[System.Drawing.ColorTranslator]::FromHtml($hexText); $grpCon.Font=$fontHeader; $grpCon.BackColor=[System.Drawing.Color]::Transparent
...
function Add-Input($p, $l, $w, $d, $pass=$false){ 
    ...
    $bx=New-Object System.Windows.Forms.TextBox; $bx.Text=$d; $bx.Location="0,20"; $bx.Width=$w-10; $bx.BackColor=$colInputBg; $bx.ForeColor=[System.Drawing.ColorTranslator]::FromHtml($hexAccent); $bx.BorderStyle="FixedSingle"; $bx.Font=$fontNorm
...
$lbSyncType = New-Object System.Windows.Forms.Label; $lbSyncType.Text="Sync Mode"; $lbSyncType.AutoSize=$true; $lbSyncType.ForeColor=$colText; $lbSyncType.Font=$fontNorm; $pnSyncType.Controls.Add($lbSyncType)
...
$Script:cmbSyncType.Location="0,20"; $Script:cmbSyncType.Width=210; $Script:cmbSyncType.BackColor=$colInputBg; $Script:cmbSyncType.ForeColor=[System.Drawing.ColorTranslator]::FromHtml($hexAccent); $Script:cmbSyncType.DropDownStyle="DropDownList"; $Script:cmbSyncType.FlatStyle="Flat"
...
$Script:chkAutoSync = New-Object System.Windows.Forms.CheckBox; $Script:chkAutoSync.Text="Auto Update DB"; $Script:chkAutoSync.ForeColor=[System.Drawing.ColorTranslator]::FromHtml($hexAccent); $Script:chkAutoSync.AutoSize=$true; $Script:chkAutoSync.Checked=$true; $Script:chkAutoSync.Margin=New-Object System.Windows.Forms.Padding(10,25,0,0); $flowCon.Controls.Add($Script:chkAutoSync)

$Script:btnCon = New-Object System.Windows.Forms.Button; $Script:btnCon.Text="CONNECT"; $Script:btnCon.Size="110,35"; $Script:btnCon.Margin=New-Object System.Windows.Forms.Padding(15,12,0,0); Set-ProButton $Script:btnCon $hexAccent; $flowCon.Controls.Add($Script:btnCon)
...
$grpList = New-Object System.Windows.Forms.GroupBox; $grpList.Text=" DETECTED TARGETS "; $grpList.Dock="Fill"; $grpList.ForeColor=[System.Drawing.ColorTranslator]::FromHtml($hexText); $grpList.Font=$fontHeader; $split.Controls.Add($grpList, 0, 0)
...
$Script:listDBs = New-Object System.Windows.Forms.CheckedListBox; $Script:listDBs.Dock="Fill"; $Script:listDBs.BackColor=$colInputBg; $Script:listDBs.ForeColor=[System.Drawing.ColorTranslator]::FromHtml($hexAccent); $Script:listDBs.BorderStyle="FixedSingle"; $Script:listDBs.Font=$fontNorm; $Script:listDBs.CheckOnClick=$true; $pnlListInner.Controls.Add($Script:listDBs, 0, 1)
...
$grpLog = New-Object System.Windows.Forms.GroupBox; $grpLog.Text=" ACTIVITY LOG "; $grpLog.Dock="Fill"; $grpLog.ForeColor=[System.Drawing.ColorTranslator]::FromHtml($hexText); $grpLog.Font=$fontHeader; $split.Controls.Add($grpLog, 1, 0)
$btnClear = New-Object System.Windows.Forms.Button; $btnClear.Text = "CLEAR LOG"; $btnClear.Size = New-Object System.Drawing.Size(90, 23); $btnClear.Location = New-Object System.Drawing.Point(535, 15); $btnClear.Anchor = [System.Windows.Forms.AnchorStyles]::Top -bor [System.Windows.Forms.AnchorStyles]::Right; Set-ProButton $btnClear "#888888"; $btnClear.Font=$fontNorm; $grpLog.Controls.Add($btnClear)
...
$Script:txtLog = New-Object System.Windows.Forms.RichTextBox; $Script:txtLog.Dock="Fill"; $Script:txtLog.BackColor=$colInputBg; $Script:txtLog.ForeColor=$colText; $Script:txtLog.BorderStyle="FixedSingle"; $Script:txtLog.Font=$fontLog; $pnlLogBg.Controls.Add($Script:txtLog)
$btnClear.Add_Click({ $Script:txtLog.Clear() })

# --- ACTIONS (MIRRORED ENTERPRISE BUTTONS) ---
...
$Script:btnSync = New-Object System.Windows.Forms.Button; $Script:btnSync.Text="START SYNC PACKAGE"; $Script:btnSync.Dock="Fill"; Set-ProButton $Script:btnSync $hexAccent; $Script:btnSync.Margin=$btnMargin; $pnlAct.Controls.Add($Script:btnSync, 0, 0)
$Script:btnCopyDB = New-Object System.Windows.Forms.Button; $Script:btnCopyDB.Text="COPY TO TRAIN/TEST"; $Script:btnCopyDB.Dock="Fill"; Set-ProButton $Script:btnCopyDB "#00D2FF"; $Script:btnCopyDB.Margin=$btnMargin; $pnlAct.Controls.Add($Script:btnCopyDB, 1, 0)
$Script:btnVer = New-Object System.Windows.Forms.Button; $Script:btnVer.Text="CHECK VERSION"; $Script:btnVer.Dock="Fill"; Set-ProButton $Script:btnVer "#FFD700"; $Script:btnVer.Margin=$btnMargin; $pnlAct.Controls.Add($Script:btnVer, 2, 0)
$Script:btnBackup = New-Object System.Windows.Forms.Button; $Script:btnBackup.Text="BACKUP JOBS & PARAMS"; $Script:btnBackup.Dock="Fill"; Set-ProButton $Script:btnBackup "#B026FF"; $Script:btnBackup.Margin=$btnMargin; $pnlAct.Controls.Add($Script:btnBackup, 0, 1)
$Script:btnRestore = New-Object System.Windows.Forms.Button; $Script:btnRestore.Text="RESTORE JOBS & PARAMS"; $Script:btnRestore.Dock="Fill"; Set-ProButton $Script:btnRestore "#FF00FF"; $Script:btnRestore.Margin=$btnMargin; $pnlAct.Controls.Add($Script:btnRestore, 1, 1)
$Script:btnDeleteDB = New-Object System.Windows.Forms.Button; $Script:btnDeleteDB.Text="DELETE DATABASE"; $Script:btnDeleteDB.Dock="Fill"; Set-ProButton $Script:btnDeleteDB $hexDanger; $Script:btnDeleteDB.Margin=$btnMargin; $pnlAct.Controls.Add($Script:btnDeleteDB, 2, 1)

# --- STATUS ---
$stat = New-Object System.Windows.Forms.StatusStrip; $stat.BackColor=[System.Drawing.ColorTranslator]::FromHtml("#000000"); $lblStat = New-Object System.Windows.Forms.ToolStripStatusLabel; $lblStat.Text="System Ready."; $lblStat.ForeColor="White"; $stat.Items.Add($lblStat); [void]$masterGrid.Controls.Add($stat, 0, 5)
