...
<#
.SYNOPSIS
    Prophoenix Installation Dashboard v5.9
   #>
...
Write-Host "[INIT] Booting Prophoenix Installation Dashboard v5.9..." -ForegroundColor Cyan
...
try {
    ...
    # --- INCREASED SCRIPT LIST FONT SIZE ---
    ...
    $Url_GDrive   = "https://drive.google.com/uc?export=download&id=1cEkVLjzQtiJ1h5_1OdVNh0KA0m_XLISI"
    ...
    # --- NEW HELPER: AUTO-SWITCH TO LOGS TAB ---
    ...
    # ==========================================================================
    #  4. ADVANCED DIAGNOSTICS & PUBLIC IP (Auto-Switches to Logs)
    # ==========================================================================
    ...
    function Get-FriendlyName($fileName) {
        ...
        if ($fileName -match "ProPhoenix DB Utility Dashboard" -or $fileName -match "DB Sync") { return "DB Sync Tool" }
    ...
    # --- HYBRID LAUNCH: CMD (.bat) | ISE (Minimal Downtime) | PS NoExit (Standard .ps1) ---
    ...
    function Refresh-List {
        ...
        foreach ($item in $SortedList) {
            # CARD INCREASED HEIGHT TO FIT SIZE 11 FONT
            ...
            $Y += 36 # Perfect increment for spacing Size 11 fonts
        }
    }
    ...
    $script:form.Text = "ProPhoenix Installation Dashboard v5.9"
    ...
    # -------------------------------------------------------------------------------------
    # DYNAMIC BRAND LOGO RENDERER (TOP LEFT INSIDE HEADER)
    # -------------------------------------------------------------------------------------
    ...
    $script:btnTabScripts = New-Object System.Windows.Forms.Button; $script:btnTabScripts.Text="Available Scripts"; $script:btnTabScripts.Font=$script:Font_SideHead; $script:btnTabScripts.Size=New-Object System.Drawing.Size(360, 40); $script:btnTabScripts.Left=0; $script:btnTabScripts.BackColor=Get-Color "CardBg"; $script:btnTabScripts.ForeColor=Get-Color "TextWhite"; $script:btnTabScripts.FlatStyle="Flat"; $script:btnTabScripts.FlatAppearance.BorderSize=1; $script:btnTabScripts.FlatAppearance.BorderColor=Get-Color "TextWhite"; $script:btnTabScripts.Cursor="Hand"; $script:pnlTabs.Controls.Add($script:btnTabScripts)
...
Write-Host "Hello! This is running from a Batch file." -ForegroundColor Cyan
