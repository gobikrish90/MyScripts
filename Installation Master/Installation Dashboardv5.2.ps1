<#
.SYNOPSIS
    ProPhoenix Enterprise Deployment Dashboard (v108.0)
    - BUG FIX: Resolved "DockStyle" null exception on the minimalist toggle button.
    - UI: Sleek Telemetry Cards & Minimalist Terminal Toggle Bar.
    - CORE: Zero-scroll massive watermark logic & ISE-Safe Pathing.
#>

Write-Host "[INIT] Booting ProPhoenix Enterprise Command Center v108.0..." -ForegroundColor Cyan
...
try {
    ...
    $Font_Btn      = New-Object System.Drawing.Font("Segoe UI Semibold", 8, [System.Drawing.FontStyle]::Bold)
    ...
    # ==========================================================================
    #  4. ADVANCED DIAGNOSTICS & TELEMETRY UPDATES
    # ==========================================================================
    ...
    function Test-SftpConnection {
        ...
        try {
            ...
            if ($result.TcpTestSucceeded) {
                ...
                Write-Terminal "STATUS: FAILED (TCP Port 25544 is CLOSED or BLOCKED)" "Red"
            }
    ...
    function Launch-File($path, $friendlyName) {
        ...
        try {
            ...
            Write-Terminal "CRITICAL LAUNCH FAILURE: $_" "Red"
        }
    }
    ...
    function Refresh-List {
        ...
        foreach ($item in $SortedList) {
            ...
            $b.BackColor=$Col_BtnIdle; $b.ForeColor=$Col_White; $b.FlatStyle="Flat"; $b.FlatAppearance.BorderSize=0; $b.Font=$Font_Btn; $b.Cursor="Hand"
    ...
    $form.Text = "ProPhoenix Enterprise Deployment Dashboard v108.0"
    $form.Size = New-Object System.Drawing.Size(1250, 850)
    $form.StartPosition = "CenterScreen"
    $form.BackColor = $Col_BgDark

    # Dynamic File Path Loading for Logo
    $LogoPath = $null
    try {
    ...
    function Add-SidebarButton($Text, $Top, $Action, $HoverColor) {
        ...
        $btn.Text = $Text; $btn.TextAlign="MiddleLeft"; $btn.Font=$Font_Sub; $btn.ForeColor=$Col_White; $btn.BackColor=$Col_BtnIdle
        $btn.FlatStyle="Flat"; $btn.FlatAppearance.BorderSize=0; $btn.Left=0; $btn.Top=$Top; $btn.Size=New-Object System.Drawing.Size(280, 50); $btn.Cursor="Hand"
    ...
    Add-SidebarButton "  ☁  DOWNLOAD AZURE BLOB" 265 { Start-Process $Url_Blob } $Col_White
    Add-SidebarButton "  ☁  DOWNLOAD GOOGLE DRIVE" 320 { Start-Process $Url_GDrive } $Col_White
    Add-SidebarButton "  📂  OPEN SYSTEM LOGS" 375 { if(Test-Path (Ensure-LogDir)){ Invoke-Item (Ensure-LogDir) } } $Col_Green
    Add-SidebarButton "  📡  TEST SFTP CONNECTION" 430 { Test-SftpConnection } $Col_PhxOrange
    Add-SidebarButton "  ⚙️  RUN SYSTEM DIAGNOSTICS" 485 { Run-PreFlightDiagnostics } $Col_Cyan
    ...
    # ==========================================================================
    #  PERFECTED TELEMETRY CARDS 
    # ==========================================================================
    $pnlTelemetryWrapper = New-Object System.Windows.Forms.Panel
    $pnlTelemetryWrapper.Width = 420; $pnlTelemetryWrapper.Height = 70; $pnlTelemetryWrapper.Top = 15; $pnlTelemetryWrapper.Left = 800; 
    $pnlTelemetryWrapper.BackColor = [System.Drawing.Color]::Transparent
    $pnlHead.Controls.Add($pnlTelemetryWrapper)

    # --- Left Card: Status & Time ---
    $pnlCardLeft = New-Object System.Windows.Forms.Panel; $pnlCardLeft.Width = 200; $pnlCardLeft.Height = 55; $pnlCardLeft.BackColor = $Col_CardBg; 
    $pnlTelemetryWrapper.Controls.Add($pnlCardLeft)

    $lblSystemStatus = New-Object System.Windows.Forms.Label; $lblSystemStatus.Text="SYSTEM STATUS"; $lblSystemStatus.Font=$Font_Card_Lbl; $lblSystemStatus.ForeColor=$Col_GreyishWhite; 
    $lblSystemStatus.Left=10; $lblSystemStatus.Top=8; $lblSystemStatus.AutoSize=$true; $pnlCardLeft.Controls.Add($lblSystemStatus)
    
    $Global:lblSystemStatusVal = New-Object System.Windows.Forms.Label; $Global:lblSystemStatusVal.Text="ONLINE"; $Global:lblSystemStatusVal.Font=$Font_Card_Val; $Global:lblSystemStatusVal.ForeColor=$Col_Green; 
    $Global:lblSystemStatusVal.Left=120; $Global:lblSystemStatusVal.Top=7; $Global:lblSystemStatusVal.AutoSize=$true; $pnlCardLeft.Controls.Add($Global:lblSystemStatusVal)

    $lblSessionTime = New-Object System.Windows.Forms.Label; $lblSessionTime.Text="SESSION TIME"; $lblSessionTime.Font=$Font_Card_Lbl; $lblSessionTime.ForeColor=$Col_GreyishWhite; 
    $lblSessionTime.Left=10; $lblSessionTime.Top=30; $lblSessionTime.AutoSize=$true; $pnlCardLeft.Controls.Add($lblSessionTime)
    
    $Global:lblSessionTimeVal = New-Object System.Windows.Forms.Label; $Global:lblSessionTimeVal.Text="00:00:00"; $Global:lblSessionTimeVal.Font=$Font_Card_Val; $Global:lblSessionTimeVal.ForeColor=$Col_Cyan; 
    $Global:lblSessionTimeVal.Left=120; $Global:lblSessionTimeVal.Top=29; $Global:lblSessionTimeVal.AutoSize=$true; $pnlCardLeft.Controls.Add($Global:lblSessionTimeVal)

    # --- Right Card: Host & IP ---
    $pnlCardRight = New-Object System.Windows.Forms.Panel; $pnlCardRight.Width = 200; $pnlCardRight.Height = 55; $pnlCardRight.Left = 210; $pnlCardRight.BackColor = $Col_CardBg; 
    $pnlTelemetryWrapper.Controls.Add($pnlCardRight)

    $lblHostname = New-Object System.Windows.Forms.Label; $lblHostname.Text="HOSTNAME"; $lblHostname.Font=$Font_Card_Lbl; $lblHostname.ForeColor=$Col_GreyishWhite; 
    $lblHostname.Left=10; $lblHostname.Top=8; $lblHostname.AutoSize=$true; $pnlCardRight.Controls.Add($lblHostname)
    
    $lblHostnameVal = New-Object System.Windows.Forms.Label; $lblHostnameVal.Text=$HostName; $lblHostnameVal.Font=$Font_Card_Val; $lblHostnameVal.ForeColor=$Col_White; 
    $lblHostnameVal.Left=95; $lblHostnameVal.Top=7; $lblHostnameVal.AutoSize=$true; $pnlCardRight.Controls.Add($lblHostnameVal)

    $lblIpAddress = New-Object System.Windows.Forms.Label; $lblIpAddress.Text="IP ADDRESS"; $lblIpAddress.Font=$Font_Card_Lbl; $lblIpAddress.ForeColor=$Col_GreyishWhite; 
    $lblIpAddress.Left=10; $lblIpAddress.Top=30; $lblIpAddress.AutoSize=$true; $pnlCardRight.Controls.Add($lblIpAddress)
    
    $lblIpAddressVal = New-Object System.Windows.Forms.Label; $lblIpAddressVal.Text=$IpAddress; $lblIpAddressVal.Font=$Font_Card_Val; $lblIpAddressVal.ForeColor=$Col_Cyan; 
    $lblIpAddressVal.Left=95; $lblIpAddressVal.Top=29; $lblIpAddressVal.AutoSize=$true; $pnlCardRight.Controls.Add($lblIpAddressVal)

    # Global Timer for Session Time
    ...
    $Global:btnToggleLog.Text = "▼ LOGS"
    
    # 🛑 CRITICAL FIX: "Fill" is a string that PowerShell auto-casts to DockStyle.
    $Global:btnToggleLog.Dock = "Fill" 
    
    $Global:btnToggleLog.BackColor = $Col_BtnIdle
    $Global:btnToggleLog.ForeColor = $Col_PhxOrange
    $Global:btnToggleLog.FlatStyle = "Flat"
    $Global:btnToggleLog.FlatAppearance.BorderSize = 0
    $Global:btnToggleLog.Font = $Font_Btn
