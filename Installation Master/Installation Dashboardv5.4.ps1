<#
.SYNOPSIS
    ProPhoenix Installation Dashboard (v5.4)
    - BUG FIX: Injected Deep Double-Buffering to stop the center logo from tearing/glitching.
    - BUG FIX: Added SuspendLayout and Invalidate logic to the Toggle Button for smooth resizing.
    - CORE: Retains Golden toggle button, telemetry cards, and neat sidebar.
#>

Write-Host "[INIT] Booting ProPhoenix Enterprise Command Center v110.0..." -ForegroundColor Cyan
...
try {
    ...
    $form.Text = "ProPhoenix Installation Dashboard (v5.4)"
    ...
    # FIX: Suspend the layout, resize, and forcefully repaint the background so it doesn't glitch
    $Global:btnToggleLog.Add_Click({
        ...
        # Force an immediate, hard redraw of the transparent panel and background
