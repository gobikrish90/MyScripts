<#
.SYNOPSIS
    Prophoenix Installation Dashboard v8.4
    - FEATURE: Added Active Directory (ADSI) querying to fetch User's Company/Agency Name.
    - UI: Expanded Telemetry panel to display the fetched Agency/Domain alongside Hostname and IP.
    - CORE: Retains Dashboard Guide, Glass Theme, Dual-Screen Tabs, and Hybrid Launching.
#>
...
Write-Host "[INIT] Booting Prophoenix Installation Dashboard v8.4..." -ForegroundColor Cyan
...
# ==========================================================================
#  EMBEDDED STEP-BY-STEP GUIDE TEXT
# ==========================================================================
$script:GuideText = @"
================================================================================
...
function Show-DashboardGuide {
    ...
    $guideForm.BackColor = Get-Color "BgMain"
    $guideForm.ForeColor = Get-Color "TextWhite"

    $rtb = New-Object System.Windows.Forms.RichTextBox
    $rtb.Dock = "Fill"
    $rtb.BackColor = Get-Color "CardBg"
    $rtb.ForeColor = Get-Color "TextWhite"
...
Add-SidePillButton "Download Prerequisite" 255 "BtnBlue" "BtnBlueHover" { Start-Process $Url_Blob; Start-Process $Url_GDrive }
Add-SidePillButton "Request Blob Access" 300 "BtnBlue" "BtnBlueHover" { Request-BlobAccess }
...
$lblTitle = New-Object System.Windows.Forms.Label; $lblTitle.Text="Phoenix Dashboard"; $lblTitle.Font=$script:Font_MainTitle; $lblTitle.Left=260; $lblTitle.Top=30; $lblTitle.AutoSize=$true; $lblTitle.ForeColor=Get-Color "TextWhite"; $script:pnlHead.Controls.Add($lblTitle)
...
$pnlTelemetryWrapper = New-Object System.Windows.Forms.Panel; $pnlTelemetryWrapper.Width = 520; $pnlTelemetryWrapper.Height = 85; $pnlTelemetryWrapper.Top = 20; $pnlTelemetryWrapper.Left = 640; $pnlTelemetryWrapper.BackColor = [System.Drawing.Color]::Transparent; $script:pnlHead.Controls.Add($pnlTelemetryWrapper)
...
$script:btnHelpDocs.Text = "? Dashboard Guide"
