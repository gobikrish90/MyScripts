...
function Show-DashboardGuide {
    ...
    # --- BRIGHT THEME FOR HELP DOCS ---
    $guideForm.BackColor = [System.Drawing.Color]::FromArgb(245, 245, 245) # Light gray app border
    $guideForm.ForeColor = [System.Drawing.Color]::Black

    $rtb = New-Object System.Windows.Forms.RichTextBox
    $rtb.Dock = "Fill"
    $rtb.BackColor = [System.Drawing.Color]::White # Pure white document background
    $rtb.ForeColor = [System.Drawing.Color]::FromArgb(30, 30, 30) # Soft black text for readability
