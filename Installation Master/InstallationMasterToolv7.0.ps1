...
Write-Host "[INIT] Booting Installation Master Tool v7.0..." -ForegroundColor Cyan
...
function Request-BlobAccess {
    ...
    try {
        ...
        # Email Parameters (Note: Commas are required for Office 365 Deeplink CC fields)
        $to = "Cloudsupport@prophoenix.com"
        $cc = "Installation@prophoenix.com,itsupport@prophoenix.com,it@prophoenix.com"
        $subject = "Blob enable"
        
        # URL Encoded Body (%0D%0A creates the line breaks)
        # Office 365 automatically appends the user's internal signature below this text.
        ...
        # Office 365 Deep Link URL - This inherently handles the login wait/redirect!
        $owaUrl = "https://outlook.office.com/mail/deeplink/compose?to=$to&cc=$cc&subject=$subject&body=$body"
        
        # Launch default browser directly to O365
