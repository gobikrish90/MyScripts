<#
.SYNOPSIS
    Prophoenix Installation Dashboard (v58.0 - Individual Script Logging)
    - NEW: Creates separate log files for EACH script (e.g., 'Logs\DB Sync Tool.log').
    - LOGGING: detailed timestamps for every launch in its specific file.
    - CORE: Retains Auto-Repair, Permissions, Deep Search, and OneDrive fixes.
#>
...
# 1. Main Dashboard Log (Global History)
...
# 2. Individual Script Log (Specific History)
...
$form.Text = "Prophoenix Installation Dashboard v58.0"
...
function Refresh-List {
    ...
    foreach ($item in $SortedList) {
        ...
        # Pass Friendly Name to Launch-File for logging
