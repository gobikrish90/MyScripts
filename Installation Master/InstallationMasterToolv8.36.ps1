<#
.SYNOPSIS
    Installation Master Tool v8.40 (Pipeline Edition)
    - BUGFIX: Removed Dashboard Screenshot infinite loop.
    - BUGFIX: Tab close buttons [X] added to dynamically close server logs.
    - BUGFIX: Watermark broken icon removed for .exe compilation.
    - BUGFIX: Local execution restored for Hotfix scripts.
    - FEATURE: Orchestrated Pipeline (App + DB Sync) added to Remote Manager.
    - COMPLIANCE: Prioritizes all environment drives for detection.
    - COMPLIANCE: Strictly skips Hub/Gateway paths.
#>
...
Write-Host "[INIT] Booting Installation Master Tool v8.40..." -ForegroundColor Cyan
...
function global:Add-LogTab($tabName) {
    ...
    $tabWidth = if ($tabName -eq "ALL" -or $tabName -eq "LOCAL") { 100 } else { 180 }
    ...
    $btn.Text = $tabName
    $btn.Size = New-Object System.Drawing.Size($tabWidth - 25, 30)
    ...
    # --- CLOSABLE TAB FEATURE ---
    if ($tabName -ne "ALL" -and $tabName -ne "LOCAL") {
        $btnClose = New-Object System.Windows.Forms.Button
        $btnClose.Text = "X"
        $btnClose.Size = New-Object System.Drawing.Size(25, 30)
        $btnClose.Location = New-Object System.Drawing.Point($tabWidth - 25, 0)
        ...
        $btnClose.Add_Click({
            $script:pnlLogTabs.Controls.Remove($tabContainer)
            $script:pnlLogContent.Controls.Remove($global:LogBoxes[$tabName])
            $global:LogTabs.Remove($tabName)
            $global:LogBoxes.Remove($tabName)
    ...
    $btn.Add_Click({ param($sender, $e) global:Switch-LogTab $tabName }.GetNewClosure())
}
...
function global:Execute-ScheduledJob($job) {
    ...
    foreach ($t in $job.Targets) {
        if ($global:LogTabs -and $global:LogTabs.ContainsKey($t.HostName)) {
            $global:LogTabs[$t.HostName].Controls[0].Text = "$($t.HostName) (Running)"
            $global:LogTabs[$t.HostName].Controls[0].ForeColor = [System.Drawing.Color]::Cyan
        }
    ...
    $sb = {
        ...
        while (-not $proc.HasExited) {
            if ($null -eq $task -or $task.IsCompleted) {
                ...
                $timeout += 50
                if ($timeout -ge 500 -and $lineBuffer.Length -gt 0) {
...
function global:Launch-File($path, $friendlyName) {
    ...
    if ($global:RemoteTargets.Count -gt 0) {
        ...
        try {
            ...
            foreach ($t in $global:RemoteTargets) {
                ...
                $sb = {
                    ...
                    $proc.StartInfo.FileName = "cmd.exe"
                    if ($rPath -match "\.ps1$") {
                        $proc.StartInfo.Arguments = "/c `"powershell.exe -NoProfile -ExecutionPolicy Bypass -File `"$rPath`" 2>&1`""
                    } else {
                        $proc.StartInfo.Arguments = "/c `"`"$rPath`"`" 2>&1"
                    }
        ...
        # LOCAL EXECUTION: Safely pass arrays so native powershell windows spawn correctly without space errors
        ...
        try {
            if ($path -match "\.bat$") { 
                Start-Process "cmd.exe" -ArgumentList "/c", "`"$path`"" -WorkingDirectory $workDir 
            } 
            elseif ($path -match "Minimal Downtime") { 
                Start-Process "powershell_ise.exe" -ArgumentList "-NoProfile", "-File", "`"$path`"" -WorkingDirectory $workDir 
            } 
            else { 
                Start-Process "powershell.exe" -ArgumentList "-NoExit", "-ExecutionPolicy", "Bypass", "-File", "`"$path`"" -WorkingDirectory $workDir 
            }
...
function global:Show-Scheduler {
    ...
    $btnSch.FlatStyle = "Flat"; $btnSch.FlatAppearance.BorderSize = 0; $btnSch.Font = New-Object System.Drawing.Font("Segoe UI", 10, [System.Drawing.FontStyle]::Bold); $btnSch.Cursor = "Hand"
    ...
    $btnCan.FlatStyle = "Flat"; $btnCan.FlatAppearance.BorderSize = 0; $btnCan.Font = New-Object System.Drawing.Font("Segoe UI", 10, [System.Drawing.FontStyle]::Bold); $btnCan.Cursor = "Hand"
...
function global:Show-RemoteManager {
    ...
    $lblDb.Location = New-Object System.Drawing.Point(20, 295); $lblDb.AutoSize = $true
    $remForm.Controls.Add($lblDb)

    $cmbDb = New-Object System.Windows.Forms.ComboBox
    $cmbDb.Location = New-Object System.Drawing.Point(20, 315); $cmbDb.Size = New-Object System.Drawing.Size(400, 25)
    ...
    $lblSqlInst.Text = "SQL Instance Name (e.g., SQLEXPRESS or default):"
    $lblSqlInst.Location = New-Object System.Drawing.Point(20, 355); $lblSqlInst.AutoSize = $true
    $remForm.Controls.Add($lblSqlInst)

    $txtSqlInst = New-Object System.Windows.Forms.TextBox
    $txtSqlInst.Location = New-Object System.Drawing.Point(20, 375); $txtSqlInst.Size = New-Object System.Drawing.Size(400, 25)
    $txtSqlInst.Text = "MSSQLSERVER"
    $remForm.Controls.Add($txtSqlInst)

    $lblSqlUser = New-Object System.Windows.Forms.Label
    $lblSqlUser.Text = "SQL Username (e.g., sa):"
    $lblSqlUser.Location = New-Object System.Drawing.Point(20, 415); $lblSqlUser.AutoSize = $true
    $remForm.Controls.Add($lblSqlUser)

    $txtSqlUser = New-Object System.Windows.Forms.TextBox
    $txtSqlUser.Location = New-Object System.Drawing.Point(20, 435); $txtSqlUser.Size = New-Object System.Drawing.Size(190, 25)
    $remForm.Controls.Add($txtSqlUser)

    $lblSqlPass = New-Object System.Windows.Forms.Label
    $lblSqlPass.Text = "SQL Password:"
    $lblSqlPass.Location = New-Object System.Drawing.Point(230, 415); $lblSqlPass.AutoSize = $true
    $remForm.Controls.Add($lblSqlPass)

    $txtSqlPass = New-Object System.Windows.Forms.TextBox
    $txtSqlPass.Location = New-Object System.Drawing.Point(230, 435); $txtSqlPass.Size = New-Object System.Drawing.Size(190, 25)
    ...
    $btnPipeline.Location = New-Object System.Drawing.Point(20, 480); $btnPipeline.Size = New-Object System.Drawing.Size(400, 45)
    ...
    $btnPipeline.Add_Click({
        if (-not $cmbApp.SelectedItem -or -not $cmbDb.SelectedItem) { [System.Windows.Forms.MessageBox]::Show("Please select an App and DB Server.", "Error", 0, 16); return }
        ...
        if ($dbScript) {
            ...
            $configPayload = "Environment=Test`r`nSyncMode=3`r`nSave=True`r`nAutoUpdateDB=True`r`nSQLUser=$sqlU`r`nSQLPass=$sqlP`r`nSQLInstance=$sqlI"
    ...
    $lblOr.Location = New-Object System.Drawing.Point(20, 540); $lblOr.AutoSize = $true; $lblOr.ForeColor = [System.Drawing.Color]::FromArgb(255, 160, 160, 170)
    $remForm.Controls.Add($lblOr)

    $lblHost = New-Object System.Windows.Forms.Label
    $lblHost.Text = "Hostname or IP Address:"
    $lblHost.Location = New-Object System.Drawing.Point(20, 560); $lblHost.AutoSize = $true
    $remForm.Controls.Add($lblHost)

    $txtHost = New-Object System.Windows.Forms.TextBox
    $txtHost.Location = New-Object System.Drawing.Point(20, 580); $txtHost.Size = New-Object System.Drawing.Size(400, 25)
    ...
    $lblUser.Location = New-Object System.Drawing.Point(20, 610); $lblUser.AutoSize = $true
    $remForm.Controls.Add($lblUser)

    $txtUser = New-Object System.Windows.Forms.TextBox
    $txtUser.Location = New-Object System.Drawing.Point(20, 630); $txtUser.Size = New-Object System.Drawing.Size(190, 25)
    ...
    $lblPass.Location = New-Object System.Drawing.Point(230, 610); $lblPass.AutoSize = $true
    $remForm.Controls.Add($lblPass)

    $txtPass = New-Object System.Windows.Forms.TextBox
    $txtPass.Location = New-Object System.Drawing.Point(230, 630); $txtPass.Size = New-Object System.Drawing.Size(190, 25)
    ...
    $btnPushAdd.Location = New-Object System.Drawing.Point(20, 670); $btnPushAdd.Size = New-Object System.Drawing.Size(400, 35)
    ...
    $btnDisconnect.Location = New-Object System.Drawing.Point(130, 720); $btnDisconnect.Size = New-Object System.Drawing.Size(200, 35)
    ...
    try {
        ...
        foreach ($loc in $SearchLocations) {
            ...
            if ($dir -and (Test-Path $dir)) {
                ...
                # Limit depth to 4 to prevent hanging on entire drive search, while ignoring Hub/Gateway
                $zips = Get-ChildItem -Path $dir -Filter $ZipNamePattern -File -Recurse -Depth 4 -ErrorAction SilentlyContinue | Where-Object { $_.FullName -notmatch "(?i)Hub|Gateway" } | Sort-Object LastWriteTime -Descending
                ...
                if ($null -ne $aj.Job) {
                    ...
                    if ($aj.Job.State -in 'Completed','Failed','Stopped') {
                        ...
                        if ($global:LogTabs -and $global:LogTabs.ContainsKey($aj.Target)) {
                            $global:LogTabs[$aj.Target].Controls[0].Text = "$($aj.Target) (Done)"
                            $global:LogTabs[$aj.Target].Controls[0].ForeColor = [System.Drawing.Color]::FromArgb(255, 46, 204, 113)
                        }
