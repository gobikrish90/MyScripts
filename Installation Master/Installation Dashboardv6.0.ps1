<#
.SYNOPSIS
    Prophoenix Installation Dashboard v8.1
    - FEATURE: Embedded the official Step-by-Step Installation Guide directly into the Dashboard.
    - FEATURE: Added "? Dashboard Guide" button to view the instructions in a custom readable window.
    - CORE: Retains Glass Theme, Native App Mode, Dual-Screen Tabs, and Hybrid Launching.
#>
...
Write-Host "[INIT] Booting Prophoenix Installation Dashboard v8.1..." -ForegroundColor Cyan
...
# --- NEW: GLOBAL DASHBOARD GUIDE BUTTON ---
