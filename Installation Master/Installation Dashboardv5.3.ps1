<#
.SYNOPSIS
    ProPhoenix Enterprise Deployment Dashboard (v109.0)
    - UI FIX: Rebuilt Toggle Button in Golden color and forced it to the front layer.
    - UI FIX: Neatly arranged left sidebar buttons using proper UI Padding and cleaner fonts.
    - CORE: Retained zero-scroll watermark, telemetry cards, and SysAdmin STDOUT terminal.
#>

Write-Host "[INIT] Booting ProPhoenix Enterprise Command Center v109.0..." -ForegroundColor Cyan
...
try {
    ...
    $Col_GoldToggle   = [System.Drawing.Color]::FromArgb(255, 193, 7) # highly visible golden amber
    ...
    $Font_SideBtn  = New-Object System.Drawing.Font("Segoe UI", 9, [System.Drawing.FontStyle]::Bold) # Neater side font
    ...
    function Refresh-List {
        ...
        # Ensure Toggle Button stays perfectly on top of the list panel
    ...
    $form.Text = "ProPhoenix Enterprise Deployment Dashboard v109.0"
    ...
    # --- NEATLY ARRANGED SIDEBAR BUTTONS (FIXED PADDING & FONTS) ---
    function Add-SidebarButton($Text, $Top, $Action, $HoverColor) {
        $btn = New-Object System.Windows.Forms.Button
        $btn.Text = $Text
        $btn.TextAlign = "MiddleLeft"
        $btn.Padding = New-Object System.Windows.Forms.Padding(25, 0, 0, 0) # Neatly indents the text
        $btn.Font = $Font_SideBtn
        $btn.ForeColor = $Col_White
        $btn.BackColor = $Col_BtnIdle
        $btn.FlatStyle = "Flat"
    ...
    # ==========================================================================
    #  FIXED: GOLDEN LOG TOGGLE BUTTON (ANCHORED TO TOP LAYER)
    # ==========================================================================
    $Global:btnToggleLog = New-Object System.Windows.Forms.Button
    $Global:btnToggleLog.Text = "▼ HIDE LOGS"
    $Global:btnToggleLog.Size = New-Object System.Drawing.Size(120, 30)
    $Global:btnToggleLog.Anchor = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right
    $Global:btnToggleLog.Location = New-Object System.Drawing.Point(775, 455)
    
    # Stylized Golden Button
    ...
    $pnlToolsWrapper.Controls.Add($Global:btnToggleLog)
    $Global:btnToggleLog.BringToFront() # Prevents it from getting lost behind lists
