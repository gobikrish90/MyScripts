...
# ==============================================================================
$SqlServerInstance = "chpnx862"       # Your Server Instance
$SourceDBName      = "PhoenixPolice" # Your RMS DB
$DestinationDBName = "CADVehLog"     # Your VehLog DB

# Hardcoded SQL Credentials
$SqlUser           = "pnxmgmt"            # Your SQL Username
$SqlPassword       = "DB@~PnxC0nf"  # REPLACE WITH YOUR ACTUAL SA PASSWORD
# ==============================================================================

Write-Host "Starting deployment to Server: $SqlServerInstance" -ForegroundColor Cyan
Write-Host "Source DB: $SourceDBName | Destination DB: $DestinationDBName" -ForegroundColor Cyan
...
# ==============================================================================
# 3. EXECUTE SCRIPT VIA INVOKE-SQLCMD
# ==============================================================================
try {
    # Added -TrustServerCertificate to bypass the SSL validation error
    Invoke-Sqlcmd -ServerInstance $SqlServerInstance -Database "master" -Username $SqlUser -Password $SqlPassword -Query $SqlScript -TrustServerCertificate -ErrorAction Stop
    Write-Host "Deployment completed successfully!" -ForegroundColor Green
}
catch {
    Write-Host "An error occurred during SQL execution:" -ForegroundColor Red
