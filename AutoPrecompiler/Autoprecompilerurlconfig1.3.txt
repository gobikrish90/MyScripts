# =============================================================================
# PHOENIX PRECOMPILER: SMART LAUNCH (Based on IIS Count)
# =============================================================================
...
# --- STEP 3: LOCATE TOOL (FIXED: KILL PROCESS BEFORE UPDATE) ---
...
# STOP RUNNING PROCESSES to prevent Access Denied
...
if (-not [string]::IsNullOrWhiteSpace($blobUrl)) {
    ...
    try {
        ...
        if (Test-Path $downloadPath) { $zipPath = $downloadPath }
    } catch { Write-Host "Download failed. searching locally..." -ForegroundColor Yellow }
}
