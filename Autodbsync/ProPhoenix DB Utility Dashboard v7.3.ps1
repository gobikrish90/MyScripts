...
# ======================================================================
#  ProPhoenix DB Utility Dashboard - v7.3
# ======================================================================
...
$form.Text = "ProPhoenix DB Utility Dashboard - v7.3"
...
$lblTitle = New-Object System.Windows.Forms.Label; $lblTitle.Text="Prophoenix DB Sync Dashboard"; $lblTitle.AutoSize=$true; $lblTitle.Location="100,15"; $lblTitle.Font=$fontTitle; $lblTitle.ForeColor=[System.Drawing.Color]::DodgerBlue; $pnlHead.Controls.Add($lblTitle)
...
$Script:txtPath = New-Object System.Windows.Forms.TextBox; $Script:txtPath.Location="820,12"; $Script:txtPath.Size="350,25"; $Script:txtPath.BackColor=$colInputBg; $Script:txtPath.ForeColor="White"; $Script:txtPath.BorderStyle="FixedSingle"; $pnlHead.Controls.Add($Script:txtPath)
$Script:btnBrowse = New-Object System.Windows.Forms.Button; $Script:btnBrowse.Text="Browse"; $Script:btnBrowse.Location="1180,12"; $Script:btnBrowse.Size="80,25"; $Script:btnBrowse.BackColor=$colBtn; $Script:btnBrowse.ForeColor="White"; $Script:btnBrowse.FlatStyle="Flat"; $pnlHead.Controls.Add($Script:btnBrowse)
$lblVerDisplay = New-Object System.Windows.Forms.Label; $lblVerDisplay.Text="Ver: --"; $lblVerDisplay.AutoSize=$false; $lblVerDisplay.TextAlign="MiddleRight"; $lblVerDisplay.Size="300,20"; $lblVerDisplay.Location="960,40"; $lblVerDisplay.ForeColor="Gray"; $pnlHead.Controls.Add($lblVerDisplay)
...
$Script:btnCreateDB = New-Object System.Windows.Forms.Button; $Script:btnCreateDB.Text="Create New DB"; $Script:btnCreateDB.Location="200,15"; $Script:btnCreateDB.Size="160,40"; $Script:btnCreateDB.BackColor=[System.Drawing.Color]::DodgerBlue; $Script:btnCreateDB.ForeColor="White"; $Script:btnCreateDB.FlatStyle="Flat"; $pnlAdmin.Controls.Add($Script:btnCreateDB)
$Script:btnInstall = New-Object System.Windows.Forms.Button; $Script:btnInstall.Text="Install Utility"; $Script:btnInstall.Location="380,15"; $Script:btnInstall.Size="160,40"; $Script:btnInstall.BackColor=[System.Drawing.Color]::SeaGreen; $Script:btnInstall.ForeColor="White"; $Script:btnInstall.FlatStyle="Flat"; $pnlAdmin.Controls.Add($Script:btnInstall)
$Script:btnUninstall = New-Object System.Windows.Forms.Button; $Script:btnUninstall.Text="Uninstall Utility"; $Script:btnUninstall.Location="560,15"; $Script:btnUninstall.Size="160,40"; $Script:btnUninstall.BackColor=[System.Drawing.Color]::IndianRed; $Script:btnUninstall.ForeColor="White"; $Script:btnUninstall.FlatStyle="Flat"; $pnlAdmin.Controls.Add($Script:btnUninstall)
$Script:btnSqlMem = New-Object System.Windows.Forms.Button; $Script:btnSqlMem.Text="SQL Memory Setting"; $Script:btnSqlMem.Location="740,15"; $Script:btnSqlMem.Size="180,40"; $Script:btnSqlMem.BackColor=[System.Drawing.Color]::MediumPurple; $Script:btnSqlMem.ForeColor="White"; $Script:btnSqlMem.FlatStyle="Flat"; $pnlAdmin.Controls.Add($Script:btnSqlMem)
...
$Script:cmbEnv = New-Object System.Windows.Forms.ComboBox; $Script:cmbEnv.Items.AddRange(@("LIVE", "TEST", "ALL")); $Script:cmbEnv.SelectedIndex=0; $Script:cmbEnv.Location="0,20"; $Script:cmbEnv.Width=90; $Script:cmbEnv.BackColor=$colInputBg; $Script:cmbEnv.ForeColor="White"; $Script:cmbEnv.DropDownStyle="DropDownList"; $pnEnv.Controls.Add($Script:cmbEnv)
$flowCon.Controls.Add($pnEnv)

# SYNC TYPE SELECTOR
$pnSyncType = New-Object System.Windows.Forms.Panel; $pnSyncType.Size=New-Object System.Drawing.Size(220,50)
$lbSyncType = New-Object System.Windows.Forms.Label; $lbSyncType.Text="Sync Mode"; $lbSyncType.AutoSize=$true; $lbSyncType.ForeColor="Cyan"; $lbSyncType.Font=$fontNorm; $pnSyncType.Controls.Add($lbSyncType)
$Script:cmbSyncType = New-Object System.Windows.Forms.ComboBox
$Script:cmbSyncType.Items.AddRange(@("2 - Update/Upgrade", "3 - Update Multiple databases"))
$Script:cmbSyncType.SelectedIndex=1
$Script:cmbSyncType.Location="0,20"; $Script:cmbSyncType.Width=210; $Script:cmbSyncType.BackColor=$colInputBg; $Script:cmbSyncType.ForeColor="White"; $Script:cmbSyncType.DropDownStyle="DropDownList"
$pnSyncType.Controls.Add($Script:cmbSyncType)
$flowCon.Controls.Add($pnSyncType)

$Script:chkSave = New-Object System.Windows.Forms.CheckBox; $Script:chkSave.Text="Save"; $Script:chkSave.ForeColor="White"; $Script:chkSave.AutoSize=$true; $Script:chkSave.Margin=New-Object System.Windows.Forms.Padding(0,25,0,0); $flowCon.Controls.Add($Script:chkSave)
$Script:chkAutoSync = New-Object System.Windows.Forms.CheckBox; $Script:chkAutoSync.Text="Auto Update DB"; $Script:chkAutoSync.ForeColor="Yellow"; $Script:chkAutoSync.AutoSize=$true; $Script:chkAutoSync.Checked=$true; $Script:chkAutoSync.Margin=New-Object System.Windows.Forms.Padding(10,25,0,0); $flowCon.Controls.Add($Script:chkAutoSync)

$Script:btnCon = New-Object System.Windows.Forms.Button; $Script:btnCon.Text="CONNECT"; $Script:btnCon.Size="110,35"; $Script:btnCon.BackColor=[System.Drawing.Color]::Crimson; $Script:btnCon.ForeColor="White"; $Script:btnCon.FlatStyle="Flat"; $Script:btnCon.Margin=New-Object System.Windows.Forms.Padding(15,15,0,0); $flowCon.Controls.Add($Script:btnCon)
...
$Script:listDBs = New-Object System.Windows.Forms.CheckedListBox; $Script:listDBs.Dock="Fill"; $Script:listDBs.BackColor=$colList; $Script:listDBs.ForeColor="White"; $Script:listDBs.BorderStyle="None"; $Script:listDBs.Font=$fontNorm; $Script:listDBs.CheckOnClick=$true; $pnlListInner.Controls.Add($Script:listDBs, 0, 1)
...
$grpLog = New-Object System.Windows.Forms.GroupBox; $grpLog.Text=" Activity Log "; $grpLog.Dock="Fill"; $grpLog.ForeColor=[System.Drawing.Color]::MediumSpringGreen; $grpLog.Font=$fontHeader; $split.Controls.Add($grpLog, 1, 0)
...
$pnlLogBg.Dock = "Fill"
$pnlLogBg.Padding = New-Object System.Windows.Forms.Padding(10)
$pnlLogBg.BackColor = $colList
$grpLog.Controls.Add($pnlLogBg)

$Script:txtLog = New-Object System.Windows.Forms.RichTextBox
$Script:txtLog.Dock="Fill"
$Script:txtLog.BackColor=$colList
...
$Script:btnSync = New-Object System.Windows.Forms.Button; $Script:btnSync.Text="START DB SYNC "; $Script:btnSync.Dock="Fill"; $Script:btnSync.BackColor=[System.Drawing.Color]::DeepSkyBlue; $Script:btnSync.ForeColor="White"; $Script:btnSync.FlatStyle="Flat"; $Script:btnSync.Font=$fontHeader; $Script:btnSync.Margin=$btnMargin; $pnlAct.Controls.Add($Script:btnSync, 0, 0)
$Script:btnCopyDB = New-Object System.Windows.Forms.Button; $Script:btnCopyDB.Text="LIVE TO TRAIN/TEST"; $Script:btnCopyDB.Dock="Fill"; $Script:btnCopyDB.BackColor=[System.Drawing.Color]::Teal; $Script:btnCopyDB.ForeColor="White"; $Script:btnCopyDB.FlatStyle="Flat"; $Script:btnCopyDB.Font=$fontHeader; $Script:btnCopyDB.Margin=$btnMargin; $pnlAct.Controls.Add($Script:btnCopyDB, 1, 0)
$Script:btnVer = New-Object System.Windows.Forms.Button; $Script:btnVer.Text="CHECK VERSION"; $Script:btnVer.Dock="Fill"; $Script:btnVer.BackColor=[System.Drawing.Color]::DarkOrange; $Script:btnVer.ForeColor="White"; $Script:btnVer.FlatStyle="Flat"; $Script:btnVer.Font=$fontHeader; $Script:btnVer.Margin=$btnMargin; $pnlAct.Controls.Add($Script:btnVer, 2, 0)
$Script:btnBackup = New-Object System.Windows.Forms.Button; $Script:btnBackup.Text="BACKUP JOBS & PARAMS"; $Script:btnBackup.Dock="Fill"; $Script:btnBackup.BackColor=[System.Drawing.Color]::MediumPurple; $Script:btnBackup.ForeColor="White"; $Script:btnBackup.FlatStyle="Flat"; $Script:btnBackup.Font=$fontHeader; $Script:btnBackup.Margin=$btnMargin; $pnlAct.Controls.Add($Script:btnBackup, 0, 1)
$Script:btnRestore = New-Object System.Windows.Forms.Button; $Script:btnRestore.Text="RESTORE JOBS & PARAMS"; $Script:btnRestore.Dock="Fill"; $Script:btnRestore.BackColor=[System.Drawing.Color]::DarkSlateBlue; $Script:btnRestore.ForeColor="White"; $Script:btnRestore.FlatStyle="Flat"; $Script:btnRestore.Font=$fontHeader; $Script:btnRestore.Margin=$btnMargin; $pnlAct.Controls.Add($Script:btnRestore, 1, 1)
$Script:btnDeleteDB = New-Object System.Windows.Forms.Button; $Script:btnDeleteDB.Text="DELETE DATABASE"; $Script:btnDeleteDB.Dock="Fill"; $Script:btnDeleteDB.BackColor=[System.Drawing.Color]::Crimson; $Script:btnDeleteDB.ForeColor="White"; $Script:btnDeleteDB.FlatStyle="Flat"; $Script:btnDeleteDB.Font=$fontHeader; $Script:btnDeleteDB.Margin=$btnMargin; $pnlAct.Controls.Add($Script:btnDeleteDB, 2, 1)
