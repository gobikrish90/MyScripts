...
# --- THEME ENGINE (CYBER FORGE) ---
$colBg        = [System.Drawing.Color]::FromArgb(15, 23, 42)    # Deep Slate/Navy Base
$colText      = [System.Drawing.Color]::FromArgb(241, 245, 249) # Crisp Off-White Text
$colInputBg   = [System.Drawing.Color]::FromArgb(30, 41, 59)    # Elevated Dark Input Fields
$colInputText = [System.Drawing.Color]::FromArgb(226, 232, 240) # Bright Text for Inputs
$colLogBg     = [System.Drawing.Color]::FromArgb(2, 6, 23)      # Pitch Black/Navy for Logs
$colAccent    = [System.Drawing.Color]::FromArgb(56, 189, 248)  # Electric Cyan Accents
$colBorder    = [System.Drawing.Color]::FromArgb(51, 65, 85)    # Subtle Frame Borders
