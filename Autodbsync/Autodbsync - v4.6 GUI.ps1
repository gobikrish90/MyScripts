# ======================================================================
#  ProPhoenix DB Utility Dashboard - v4.6 (Installation Team )
# ======================================================================
...
# --- MASTER GRID LAYOUT ---
# Rows: Header, Admin, Connection, Body, Actions, Status
...
$masterGrid.RowStyles.Add((New-Object System.Windows.Forms.RowStyle([System.Windows.Forms.SizeType]::Absolute, 80))) # Action Row
...
$btnInstall = New-Object System.Windows.Forms.Button; $btnInstall.Text="Install Utility"; $btnInstall.Location="220,20"; $btnInstall.Size="200,40"; $btnInstall.BackColor=$btnGreen; $btnInstall.ForeColor="White"; $btnInstall.FlatStyle="Flat"; $pnlAdmin.Controls.Add($btnInstall)
$btnUninstall = New-Object System.Windows.Forms.Button; $btnUninstall.Text="Uninstall Utility"; $btnUninstall.Location="440,20"; $btnUninstall.Size="200,40"; $btnUninstall.BackColor=$btnRed; $btnUninstall.ForeColor="White"; $btnUninstall.FlatStyle="Flat"; $pnlAdmin.Controls.Add($btnUninstall)

# --- ROW 2: CONNECTION (RED) ---
...
# --- ROW 4: ACTION BUTTONS (TABLE GRID FIX) ---
# Replacing FlowPanel with TableLayoutPanel ensures 50/50 split and visibility
$pnlActionGrid = New-Object System.Windows.Forms.TableLayoutPanel
$pnlActionGrid.Dock="Fill"; $pnlActionGrid.ColumnCount=2; $pnlActionGrid.RowCount=1
$pnlActionGrid.ColumnStyles.Add((New-Object System.Windows.Forms.ColumnStyle([System.Windows.Forms.SizeType]::Percent, 50)))
$pnlActionGrid.ColumnStyles.Add((New-Object System.Windows.Forms.ColumnStyle([System.Windows.Forms.SizeType]::Percent, 50)))
$pnlActionGrid.Padding = New-Object System.Windows.Forms.Padding(50, 15, 50, 15) # Padding to center visually
$masterGrid.Controls.Add($pnlActionGrid, 0, 4)

$btnSync = New-Object System.Windows.Forms.Button; $btnSync.Text="START SYNC ➜"; $btnSync.Dock="Fill"; $btnSync.BackColor=$colProc; $btnSync.ForeColor="White"; $btnSync.Font=$fontHeader; $btnSync.FlatStyle="Flat"; $btnSync.Margin=New-Object System.Windows.Forms.Padding(0, 0, 20, 0)
$pnlActionGrid.Controls.Add($btnSync, 0, 0)

$btnVer = New-Object System.Windows.Forms.Button; $btnVer.Text="CHECK DB VERSIONS"; $btnVer.Dock="Fill"; $btnVer.BackColor=$btnOrange; $btnVer.ForeColor="White"; $btnVer.Font=$fontHeader; $btnVer.FlatStyle="Flat"; $btnVer.Margin=New-Object System.Windows.Forms.Padding(20, 0, 0, 0)
$pnlActionGrid.Controls.Add($btnVer, 1, 0)
