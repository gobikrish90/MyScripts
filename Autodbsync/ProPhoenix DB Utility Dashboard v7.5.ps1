...
$form.Text = "ProPhoenix DB Utility Dashboard v7.5"
...
if (Test-Path $Script:BgImage) { 
    ...
    $form.BackgroundImageLayout = "Stretch" # Stretches cleanly for a full enterprise mirror feel
...
$Script:cmbSyncType.Items.AddRange(@("2 - Update\Upgrade database", "3 - Update Multiple databases"))
