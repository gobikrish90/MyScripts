...
.SYNOPSIS
    ...
    1. STEP 1: Update Application Manager (Run First).
    2. STEP 2: Production Application Install (Hub/Gateway Excluded).
    3. STEP 3: Stage Application Install.
    4. STEP 4: Stop Services.
    5. STEP 5: Cleanup (Session Data Only).
    6. STEP 6: Update Instances.
    7. STEP 7: Start Services.
    8. STEP 8: Status Report.
...
"@
    ...
    # 2. VERIFICATION SCRIPT (CRASH PROOF)
