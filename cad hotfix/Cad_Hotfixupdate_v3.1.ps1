...
.SYNOPSIS
    ...
    FIXES:
    1. SYNTAX ERROR: Fixed "Join-Path" array error by wrapping commands in parentheses.
    2. LOGIC: Scans PnxConfigMgr.exe.config for Updater Settings.
    3. BATCH: Starts with "cd ../../../../".
#>
